              ...
              <table className="min-w-full divide-y divide-slate-500">
                ...
                <tbody> 
                  <tr className="border-b border-slate-200">
                    <td className="py-4 text-sm font-medium text-slate-700">Tesla Truck</td>
                    <td className="hidden px-3 py-4 text-sm text-right text-slate-500 sm:table-cell">48</td>
                    <td className="hidden px-3 py-4 text-sm text-right text-slate-500 sm:table-cell">$0.00</td>
                    <td className="py-4 text-sm text-right text-slate-500">$500.00</td>
                  </tr>
                  <tr className="border-b border-slate-200">
                    <td className="py-4 text-sm font-medium text-slate-700">Tesla Charging Station</td>
                    <td className="hidden px-3 py-4 text-sm text-right text-slate-500 sm:table-cell">4</td>
                    <td className="hidden px-3 py-4 text-sm text-right text-slate-500 sm:table-cell">$0.00</td>
                    <td className="py-4 text-sm text-right text-slate-500">$0.00</td>
                  </tr>
                </tbody>
                <tfoot>
                  <tr><th colSpan="3" className="hidden pt-6 text-right text-sm font-light text-slate-500 sm:table-cell">Subtotal</th><td className="pt-6 text-sm text-right text-slate-500">$0.00</td></tr>
                  ...
                  <tr><th colSpan="3" className="hidden pt-4 text-right text-sm font-normal text-slate-700 sm:table-cell">Total</th><td className="pt-4 text-sm text-right text-slate-700">$0.00</td></tr>
                </tfoot>
              </table>
            </div>
